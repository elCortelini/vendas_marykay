    ...
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md p-6 rounded-3xl shadow-2xl border border-[#E899AC]/40 space-y-6 text-center relative overflow-hidden">
        ...
        {currentUser ? (
          ...
          /* NÃO CONECTADO: Apenas Login com o Google */
          <div className="space-y-5 pt-2">
            <div className="bg-[#FAF7F5] p-5 rounded-2xl border border-[#E899AC]/30 space-y-2 text-left text-xs">
              ...
              <p className="text-gray-600 leading-relaxed text-xs">
                Faça login com sua conta do Google. Você será direcionada(o) automaticamente para a área correspondente ao seu nível de acesso.
              </p>
            </div>

            <button
              onClick={handleGoogleLogin}
              className="w-full bg-white hover:bg-gray-50 text-gray-900 font-bold py-4 px-4 rounded-2xl border border-gray-300 shadow-lg transition-all flex items-center justify-center gap-3 text-sm cursor-pointer group hover:border-[#E899AC] hover:scale-[1.02]"
            >
